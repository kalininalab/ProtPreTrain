...
from protpretrain.data.datamodules import TestDataModule
from protpretrain.models.denoise import DenoiseModel
from protpretrain.utils.cli import namespace_to_dict

if __name__ == "__main__":
    cli = LightningCLI(model_class=DenoiseModel, datamodule_class=TestDataModule, run=False, save_config_callback=None)
